AC_DEFUN([OW_PUSH_VARIABLE],
	[
		...
		eval ow_stack_entries_$1_${ow_stack_count_$1}="\"${$1}\""
...
AC_DEFUN([OW_POP_VARIABLE],
	[
		...
		if test ${ow_stack_count_$1} -gt 0; then
			ow_stack_count_$1=`expr ${ow_stack_count_$1} \- 1`
			eval $1="\"\${ow_stack_entries_$1_${ow_stack_count_$1}}\""
			unset ow_stack_entries_$1_${ow_stack_count_$1}
		else
