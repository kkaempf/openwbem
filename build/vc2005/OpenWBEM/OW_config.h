...
#ifdef OW_MONITOR_BUILD
#define OW_MONITOR_API OW_EXPORT
#else
#define OW_MONITOR_API OW_IMPORT
#endif
...
/* LD_LIBRARY_PATH env var gives path for finding shared libs */
#ifndef OW_ENV_VAR_LIBPATH 
#define OW_ENV_VAR_LIBPATH "PATH" 
#endif
